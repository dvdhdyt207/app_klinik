...
/* wrapper blok tak berpengaruh di mobile (contents) — layout HP identik */
.b-head, .b-status, .b-stats, .b-low, .b-sched, .b-visit { display: contents; }
...
@media (min-width: 920px) {
  ...
  .b-head, .b-status, .b-stats, .b-low, .b-sched, .b-visit { display: block; }
  .b-head { grid-area: head; }
  .b-status { grid-area: status; }
  .b-stats { grid-area: stats; }
  .b-low { grid-area: low; }
  .b-sched { grid-area: sched; }
  .b-visit { grid-area: visit; }

  .head { margin-bottom: 8px; }
  .clinic { font-size: 26px; }
  .stats { margin-top: 16px; }
  .b-low .section-head, .b-sched .section-head { margin-top: 6px; }
  .visit-btn { margin-top: 16px; }
}
</style>
